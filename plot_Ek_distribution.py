...
# # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # #
def compute_Ek(path_data, filename,num_CH4):
    with open('%s/%s/%s_00/CH4_velocities.dat'%(path_data, filename,structure)) as fi:
        data=fi.readlines()
    # extract velocities    
    coords=[]
...
if __name__ == "__main__":
    ...
    path_data='/home/henglu/Documents/diffusion_sampling/lammps_data'
    # data list
    # compare
    list_data=[
#         'dof_fix_NH_4CH4_10ns_298K',
# #         'dof_fix_NH_4CH4_40ns_298K',
#         'dof_fix_NH_8CH4_10ns_298K',
#         'dof_fix_NH_12CH4_10ns_298K',
#         'dof_fix_NH_16CH4_10ns_298K',
#         'dof_fix_NH_40CH4_10ns_298K',
#         'dof_fix_NH_160CH4_10ns_298K',
#         'dof_nofix_NH_4CH4_10ns_298K',
#         'dof_nofix_NH_8CH4_10ns_298K',
#         'dof_nofix_NH_12CH4_10ns_298K',
#         'dof_nofix_NH_16CH4_10ns_298K',
#         'dof_nofix_NH_40CH4_10ns_298K',
#         'dof_nofix_NH_160CH4_10ns_298K',
        'dof_nofix_NH_4CH4_10ns_298K',
        'dof_nofix_NH_4CH4_40ns_298K',
        'dof_nofix_NH_4CH4_80ns_298K',
        'dof_nofix_NH_4CH4_160ns_298K',
        'dof_nofix_NH_4CH4_320ns_298K',
        ]
...
# # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # #
    for index, filename in enumerate(list_data):
        ...
        try:
            ...
            compute_Ek(path_data, filename, num_CH4)
...
#     plt.plot(diff_all[:,0], MaxwellBoltzmann(diff_all[:,0], 250))
#     plt.plot(diff_all[:,0], MaxwellBoltzmann(diff_all[:,0], 210))
#    plt.legend(['T=298 K','250 K', '210 K']+list_data)
#    plt.legend(list_data)#+['theoretical'])
